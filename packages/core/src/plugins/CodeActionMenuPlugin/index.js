...
exports.CodeActionMenuPlugin = void 0;
...
function CodeActionMenuContainer({ anchorElem }) {
    ...
    (0, react_1.useEffect)(() => editor.registerMutationListener(code_1.CodeNode, (mutations) => {
...
const CodeActionMenuPlugin = ({ anchorElem = document.body, }) => (0, react_dom_1.createPortal)(React.createElement(CodeActionMenuContainer, { anchorElem: anchorElem }), anchorElem);
exports.CodeActionMenuPlugin = CodeActionMenuPlugin;
