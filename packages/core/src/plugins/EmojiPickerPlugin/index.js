...
exports.EmojiPickerPlugin = void 0;
...
const EmojiPickerPlugin = () => {
    ...
    (0, react_1.useEffect)(() => {
        Promise.resolve().then(() => __importStar(require('../../utils/emoji-list'))).then((file) => setEmojis(file.default));
    }, []);
...
exports.EmojiPickerPlugin = EmojiPickerPlugin;
