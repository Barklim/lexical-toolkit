...
const ImageResizer = ({ onResizeStart, onResizeEnd, buttonRef, imageRef, maxWidth, editor, showCaption, setShowCaption, captionsEnabled, }) => {
    ...
    return (React.createElement("div", { ref: controlWrapperRef },
        !showCaption && captionsEnabled && (React.createElement("button", { type: "button", className: "image-caption-button", ref: buttonRef, onClick: () => {
