...
function PrettierButton({ lang, editor, getCodeDOMNode }) {
    ...
    return (React.createElement("div", { className: "prettier-wrapper" },
        React.createElement("button", { type: "button", className: "menu-item", onClick: handleClick, onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave, "aria-label": "prettier" }, syntaxError ? React.createElement("i", { className: "format prettier-error" }) : React.createElement("i", { className: "format prettier" })),
