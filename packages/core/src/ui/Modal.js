...
const Modal = ({ onClose, children, title, closeOnClickOutside = false, }) => (0, react_dom_1.createPortal)(React.createElement(PortalImpl, { onClose: onClose, title: title, closeOnClickOutside: closeOnClickOutside }, children), document.body);
exports.Modal = Modal;
