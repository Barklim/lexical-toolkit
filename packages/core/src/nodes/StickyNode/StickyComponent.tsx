...
import { useLayoutEffectImpl as useLayoutEffect } from '../../shared/useLayoutEffect';
import { useSharedHistoryContext } from '../../context/SharedHistoryContext';
import { theme as StickyEditorTheme } from '../../themes/StickyEditorTheme';
import { LexicalContentEditable as ContentEditable } from '../../ui/ContentEditable';

// eslint-disable-next-line import/no-cycle
import { $isStickyNode } from './index';
    ...
    if (stickyContainer !== null) {
      ...
      editor.update(() => {
        ...
        if ($isStickyNode(node)) {
          (node as any).setPosition(positioning.x, positioning.y);
        }
      });
    }
    ...
    <div ref={stickyContainerRef} className="sticky-note-container">
      ...
      >
        ...
        <LexicalNestedComposer initialEditor={caption} initialTheme={StickyEditorTheme}>
          {isCollabActive ? <div>123</div> : <HistoryPlugin externalHistoryState={historyState} />}
          <PlainTextPlugin
            contentEditable={
              <ContentEditable
