...
import { exportFile, importFile, SerializedDocument, serializedDocumentFromEditorState } from '@lexical/file';
...
export const ActionsPlugin = ({
  ...
  useEffect(
    () =>
      editor.registerUpdateListener(({ dirtyElements, prevEditorState, tags }) => {
