...
const KeywordsPlugin = () => {
    ...
    const $createKeywordNode_ = (0, react_1.useCallback)((textNode) => (0, KeywordNode_1.$createKeywordNode)(textNode.getTextContent()), []);
