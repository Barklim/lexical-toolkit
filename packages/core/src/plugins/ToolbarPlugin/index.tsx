...
export const ToolbarPlugin = ({ setIsLinkEditMode }: { setIsLinkEditMode: Dispatch<boolean> }): JSX.Element => {
  ...
  const $updateToolbar = useCallback(() => {
    ...
    if ($isRangeSelection(selection) || $isTableSelection(selection)) {
      setFontSize($getSelectionStyleValueForProperty(selection as any, 'font-size', '15px'));
    }
  }, [activeEditor, editor]);
