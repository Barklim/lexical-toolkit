...
import type { Option, Options, PollNode } from './index';

import { Button } from '../../ui/Button';
import { joinClasses } from '../../utils/joinClasses';

// eslint-disable-next-line import/no-cycle
import { $isPollNode, createPollOption } from './index';

// import './PollNode.css';

function getTotalVotes(options: Options): number {
  return options.reduce((totalVotes: any, next: any) => totalVotes + next.votes.length, 0);
}
